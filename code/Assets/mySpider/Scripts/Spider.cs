...
//		Debug.Log ("0:" + edgeDists [0]);
//		Debug.Log ("1:" + edgeDists [1]);
//		Debug.Log ("2:" + edgeDists [2]);
//		Debug.Log ("3:" + edgeDists [3]);
//		Debug.Log ("x:" + headingDirection.x);
//		Debug.Log ("y:" + headingDirection.y);
		...
		if (edgeWarningDist >= edgeDists [0] && headingDirection.x < 0) {
			Debug.Log ("too close to left edge");
			...
			Debug.Log ("too close to right edge");
			if (headingDirection.y > 0) {
				Debug.Log ("anticlockwise");
				edgeHintRet=-1;
			} else {
			...
			Debug.Log ("too close to down edge");
			...
			Debug.Log ("too close to up edge");
			if (headingDirection.x > 0) {
				edgeHintRet=1;
				Debug.Log ("clockwise");
			} else {
