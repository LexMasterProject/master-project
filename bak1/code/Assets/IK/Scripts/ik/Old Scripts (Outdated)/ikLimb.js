...
function CalculateIK(){
	...
	//target.position=new Vector3(hand.position.x,target.position.y,hand.position.z);
	target.position=hand.position;
	...
	var handRotationBak= hand.rotation;
...
//	Debug.Log("1 upperArmPost:"+upperArm.position);
	//Reset arm.
	target.position = targetRelativeStartPosition + upperArm.position;
//	Debug.Log("1 upperArmPost:"+target.position);
